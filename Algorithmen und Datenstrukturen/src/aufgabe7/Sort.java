                ...
                do {
                    ...
                    if (temporary_list.size() != 0)
                        for (int i = 0; i < sorted_list.size(); i++) {
                            expense++;
                            int sort = temporary_list.get(0).getName().toLowerCase().compareTo(sorted_list.get(i).getName().toLowerCase());
                            if (sort < 0) {
                    ...
                    if (temporary_list.size() == 0) {
                        System.out.println("insertion sort expense: " + expense);
                        return sorted_list;
                    }
                } while (true);
            ...
            case "Straße":
                ...
                do {
                    ...
                    for (int i = 0; sorted_list.size() > i; i++) {
                        expense++;
                        int sort = temporary_list.get(0).getStreet().toLowerCase().compareTo(sorted_list.get(i).getStreet().toLowerCase());
                        if (sort < 0) {
                            sorted_list.add(i, temporary_list.get(0));
                            temporary_list.remove(0);
                            insert = true;
...
//                    smallestPossible = temporary_list.get(temp).getNumberOfBeds();
        ...
        System.out.println("selection sort expense: " + expense);
        return sorted_list;
    }
}
